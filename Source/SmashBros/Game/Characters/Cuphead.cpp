...
namespace SmashBros
{
	...
	void Cuphead::Load()
	{
		setFolderPath("Images/Game/Characters/Cuphead/");
	...
	void Cuphead::onAnimationFinish(const String&n)
	{
	...
	void Cuphead::Update(long gameTime)
	{
		if(attacksHolder==2)
		{
	...
	void Cuphead::onPlayerHit(Player*collide, byte dir)
	{
		switch(dir)
		{
			case DIR_LEFT:
	...
	void Cuphead::onQueueAttack(byte attackType)
	{
	...
	void Cuphead::Ray::onPlayerHit(Player*collide, byte dir)
	{
	...
	Cuphead::LandmasterShot::LandmasterShot(byte playerNo, float x1, float y1) : Projectile(playerNo, x1,y1)
	{
		Animation*anim;
		
		anim = new Animation("left",12,4,1);
		anim->addFrame("Images/Game/Characters/Cuphead/landmaster_shot.png");
		addAnimation(anim);
	...
	Cuphead::LandmasterShot::~LandmasterShot()
	{
		//
	}

	void Cuphead::LandmasterShot::onPlayerHit(Player*collide, byte dir)
	{
		if(isHittable(collide,dir))
		{
	...
	Cuphead::Landmaster::Landmaster(byte playerNo, float x1, float y1) : Projectile(playerNo, x1, y1)
	{
		Animation*anim;
		
		anim = new Animation("idle_left",1,"Images/Game/Characters/Cuphead/landmaster_idle.png");
		addAnimation(anim);
		anim = new Animation("idle_right",1,"Images/Game/Characters/Cuphead/landmaster_idle.png");
		anim->mirror(true);
		addAnimation(anim);
		
		anim = new Animation("move_left",8,4,1);
		anim->addFrame("Images/Game/Characters/Cuphead/landmaster_move.png");
		addAnimation(anim);
		...
		anim->addFrame("Images/Game/Characters/Cuphead/landmaster_boost.png");
		addAnimation(anim);
	...
	void Cuphead::Landmaster::idle()
	{
		...
		Cuphead*owner = (Cuphead*)Global::getPlayerActor(getPlayerNo());
		owner->animFinish();
