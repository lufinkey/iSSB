...
namespace SmashBros
{
	void Rayman::addProjectileInfo(byte type, int projID, float x, float y)
	{
		ProjectileInfo info;
		info.type = type;
		info.projID = projID;
	...
	Rayman::Rayman(float x1, float y1, byte playerNo, byte team) : Player(x1, y1, playerNo, team)
	{
		charging = 0;
		finalSmash = false;
	...
	void Rayman::addP2PData(DataVoid&data)
	{
	...
	void Rayman::setP2PData(byte*&data)
	{
	...
	void Rayman::Load()
	{
		setFolderPath("Images/Game/Characters/Rayman/");
		
		loadFile("Images/Game/Characters/Rayman/projectile.png");
		loadFile("Images/Game/Characters/Rayman/down_blast.png");
		loadFile("Images/Game/Characters/Rayman/finalsmash_blast.png");
		loadFile("Images/Game/Characters/Rayman/blade.png");
	...
	void Rayman::setToDefaultValues()
	{
		charging = 0;
		finalSmash = false;
		dropDownAttack = false;
	...
	void Rayman::onAnimationFinish(const String&n)
	{
	...
	void Rayman::Update(long gameTime)
	{
	...
	void Rayman::Draw(Graphics2D&g, long gameTime)
	{
	...
	void Rayman::whilePlayerColliding(Player*collide, byte dir)
	{
		if(attacksHolder==11)
		{
	...
	void Rayman::onPlayerHit(Player*collide, byte dir)
	{
		switch(dir)
		{
			case DIR_LEFT:
	...
	void Rayman::onFinishCharge()
	{
		//
	}
	
	void Rayman::doChargingAttack(byte button)
	{
		if(charging==1)
		{
			destroyCharge();
	...
	void Rayman::attackSideSmash(byte type)
	{
	...
	void Rayman::attackUpSmash(byte type)
	{
	...
	void Rayman::attackDownSmash(byte type)
	{
	...
	Rayman::Blast::Blast(byte playerNo, float x1, float y1) : Projectile(playerNo, x1, y1)
	{
		Animation*anim;
		anim = new Animation("left",1,"Images/Game/Characters/Rayman/projectile.png");
		addAnimation(anim);
			
		anim = new Animation("right",1,"Images/Game/Characters/Rayman/projectile.png");
		anim->mirror(true);
		addAnimation(anim);
	...
	void Rayman::Blast::deflect(byte dir)
	{
		switch(dir)
		{
			case DIR_LEFT:
	...
	void Rayman::Blast::Update(long gameTime)
	{
	...
	void Rayman::Blast::onPlayerHit(Player*collide, byte dir)
	{
	...
	Rayman::SpinningBlade::SpinningBlade(byte playerNo, float x1, float y1) : Projectile(playerNo,x1,y1)
	{
		Animation*anim;
			
		anim = new Animation("left",12,8,1);
		anim->addFrame("Images/Game/Characters/Rayman/blade.png");
		addAnimation(anim);
	...
	Rayman::SpinningBlade::~SpinningBlade()
	{
		//
	};
	
	void Rayman::SpinningBlade::Update(long gameTime)
	{
	...
	void Rayman::SpinningBlade::Draw(Graphics2D&g, long gameTime)
	{
		Player*owner = Global::getPlayerActor(getPlayerNo());
	...
	void Rayman::SpinningBlade::onAnimationFinish(const String&n)
	{
		Player*owner = Global::getPlayerActor(getPlayerNo());
	...
	void Rayman::SpinningBlade::onPlayerHit(Player*collide, byte dir)
	{
		if(isHittable(collide,dir))
		{
	...
	Rayman::GroundStab::GroundStab(byte playerNo, float x1, float y1) : Projectile(playerNo, x1,y1)
	{
		Animation*anim;
		anim = new Animation("normal",6,4,1);
		anim->addFrame("Images/Game/Characters/Rayman/down_blast.png");
		addAnimation(anim);
	...
	Rayman::GroundStab::~GroundStab()
	{
		//
	}
		
	void Rayman::GroundStab::onPlayerHit(Player*collide, byte dir)
	{
	...
	void Rayman::GroundStab::onAnimationFinish(const String&n)
	{
		if(n.equals("normal"))
		{
			destroy();
	...
	Rayman::FinalSmashBlast::FinalSmashBlast(byte playerNo, float x1, float y1) : Projectile(playerNo, x1,y1)
	{
		setScale(1.6f);
		
		addAnimation(new Animation("left",1,"Images/Game/Characters/Rayman/finalsmash_blast.png"));
		Animation*anim = new Animation("right",1,"Images/Game/Characters/Rayman/finalsmash_blast.png");
		anim->mirror(true);
		addAnimation(anim);
	...
	Rayman::FinalSmashBlast::~FinalSmashBlast()
	{
		//
	}
		
	void Rayman::FinalSmashBlast::onPlayerHit(Player*collide, byte dir)
	{
		if(isHittable(collide,dir))
		{
			switch(dir)
